...
static const char KeyMatrix[]={0 ,' ','e','l','v','o', 72, 27,
                                  'b','s','c','t', 75, 80, 77,
                                   13,'7','8','9','/', 83, 8 ,
                                  'w','4','5','6','*','n','u',
                                  'd','1','2','3','-','x','q',
        ...
        case 'o'://round
          if (stack_ptr[which_stack]>=1)
          {
            if (BCD_stack[(stack_ptr[which_stack]-1)*MATH_CELL_SIZE+BCD_LEN]>BCD_stack[(stack_ptr[which_stack]-1)*MATH_CELL_SIZE+BCD_DEC])
            {
              ...
              //printf(">%d<",BCD_stack[(stack_ptr[which_stack]-1)*MATH_CELL_SIZE+BCD_stack[(stack_ptr[which_stack]-1)*MATH_CELL_SIZE+BCD_LEN]+3]);
              //GetKey();
